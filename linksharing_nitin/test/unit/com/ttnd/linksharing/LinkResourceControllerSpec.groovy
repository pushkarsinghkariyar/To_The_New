...
class LinkResourceControllerSpec extends Specification {
    ...
    def "check link resource success"() {
        ...
        given:
        User user = new User(email: "saksham.sharma@tothenew.com", username: "saksham", password: DefaultPassword.DEFAULT_PASSWORD,
                firstName: "saksham", lastName: "sharma", admin: true, active: true, confirmPassword: DefaultPassword.DEFAULT_PASSWORD)
