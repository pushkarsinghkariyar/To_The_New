...
class UserSpec extends Specification {
    ...
    def "Testing unique email id"() {
        ...
        User user1 = new User(email: "test@test.com", username: "nitin", password: "nitin", firstName: "nitin", lastName: "singh", admin: true, active: true, photo: "abcd".bytes, confirmPassword: "nitin")
    ...
    def "Testing unique username"() {
        setup:
        User user = new User(email: "test@test.com", username: "nitin", password: "dummy", firstName: "dummy", lastName: "dummy", admin: true, active: true, photo: "abcd".bytes, confirmPassword: "dummy")
        User user1 = new User(email: "test1@test.com", username: "nitin", password: "nitin", firstName: "nitin", lastName: "singh", admin: true, active: true, photo: "abcd".bytes, confirmPassword: "nitin")
