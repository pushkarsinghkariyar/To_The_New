...
grails.config.locations = ["classpath:grails-app/conf/extConfig.groovy"]
...
map1 = [key: "Value"]
println "Config.groovy executed: " + map1
...
grails {
    mail {
        host = "smtp.gmail.com"
        port = 465
        username = "linksharing.grails.application@gmail.com"
        password = "defaultls"
